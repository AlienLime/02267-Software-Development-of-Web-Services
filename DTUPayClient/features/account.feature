Feature: Account
  ...
  Scenario: Customer is successfully registered
    Given a customer with name "Group17-Susan", last name "Group17-Baldwin", and CPR "170154-2950"
    And the customer is registered with the bank
    When the customer tries to register with DTU Pay using their bank account
    Then the customer is registered successfully and with the name "Group17-Susan", last name "Group17-Baldwin", and CPR "170154-2950"
  ...
  Scenario: Customer is successfully deregistered
    Given a registered customer with cpr "170154-2950"
    When the customer tries to deregister their account from DTU Pay
    Then the customer with cpr "170154-2950" is successfully deregistered

  Scenario: Merchant is successfully deregistered
    Given a registered merchant with cpr "170154-2950"
    When the merchant tries to deregister their account from DTU Pay
    Then the merchant with cpr "170154-2950" is successfully deregistered
  ...
  Scenario: Two customers register concurrently
    Given two customers with a bank account and cpr numbers "170154-2950" "170154-5435"
    When both customers register with DTU Pay
    Then the customers with cpr numbers "170154-2950" and "170154-5435" are successfully registered

  Scenario: Two merchants register concurrently
    Given two merchants with a bank account and cpr numbers "170154-2950" "170154-5435"
    When both merchants register with DTU Pay
    Then the merchants with cpr numbers "170154-2950" and "170154-5435" are successfully registered

  Scenario: Two customers deregister concurrently
    Given two registered customers with cpr numbers "170154-2950" "170154-5435"
    When both customers deregister from DTU Pay
    Then the customers with cpr numbers "170154-2950" and "170154-5435" are successfully deregistered

  Scenario: Two merchants deregister concurrently
    Given two registered merchants with cpr numbers "170154-2950" "170154-5435"
    When both merchants deregister from DTU Pay
    Then the merchants with cpr numbers "170154-2950" and "170154-5435" are successfully deregistered
