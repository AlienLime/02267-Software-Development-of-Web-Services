Feature: Full Payment
  Scenario: Successful Payment
    Given a customer with name "Group17-Katja", last name "Group17-Kaj", and CPR "170155-4456"
    ...
    Given a merchant with name "Group17-Bente", last name "Group17-Bent", and CPR "171161-3056"
